...
const PERMISSION_GROUPS: { label: string; permissions: Permission[] }[] = [
  ...
  { label: 'Authors', permissions: ['authors.view', 'authors.create', 'authors.edit', 'authors.delete'] },
  { label: 'Publishers', permissions: ['publishers.view', 'publishers.create', 'publishers.edit', 'publishers.delete'] },
  { label: 'Banners', permissions: ['banners.view', 'banners.create', 'banners.edit', 'banners.delete'] },
  ...
  { label: 'Stock', permissions: ['stock.view', 'stock.edit'] },
...
const PERMISSION_LABELS: Record<string, string> = {
  ...
  'categories.view': 'View', 'categories.create': 'Create', 'categories.edit': 'Edit',
  'categories.delete': 'Delete',
  'authors.view': 'View', 'authors.create': 'Create', 'authors.edit': 'Edit',
  'authors.delete': 'Delete',
  'publishers.view': 'View', 'publishers.create': 'Create', 'publishers.edit': 'Edit',
  'publishers.delete': 'Delete',
  'banners.view': 'View', 'banners.create': 'Create', 'banners.edit': 'Edit',
  ...
  'stock.view': 'View', 'stock.edit': 'Edit',
